...
import { beginLinkedinAuth, getLinkedinConfig } from "@/src/features/auth/lib/linkedin";
...
const GoogleIcon = ({ size = 16 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 28 28" fill="none" aria-hidden="true">
    <g clipPath="url(#sb_g_clip)">
      <path
        d="M27.7268 14.3225C27.7268 13.3709 27.6496 12.414 27.485 11.4778H14.2798V16.8689H21.8418C21.528 18.6077 20.5197 20.1458 19.0433 21.1232V24.6213H23.5548C26.2041 22.1829 27.7268 18.582 27.7268 14.3225Z"
        fill="#4285F4"
      />
      <path
        d="M14.2798 28.0009C18.0557 28.0009 21.2399 26.7611 23.56 24.6211L19.0485 21.1231C17.7933 21.977 16.1729 22.4606 14.2849 22.4606C10.6325 22.4606 7.53572 19.9965 6.42456 16.6836H1.76904V20.2897C4.14567 25.0172 8.98639 28.0009 14.2798 28.0009Z"
        fill="#34A853"
      />
      <path
        d="M6.41941 16.6837C5.83297 14.9449 5.83297 13.0621 6.41941 11.3234V7.71729H1.76904C-0.216632 11.6732 -0.216632 16.3339 1.76904 20.2898L6.41941 16.6837Z"
        fill="#FBBC04"
      />
      <path
        d="M14.2798 5.54127C16.2757 5.51041 18.2048 6.26146 19.6504 7.64012L23.6474 3.64305C21.1165 1.26642 17.7573 -0.0402103 14.2798 0.000943444C8.98638 0.000943444 4.14567 2.98459 1.76904 7.71728L6.41942 11.3234C7.52542 8.00536 10.6274 5.54127 14.2798 5.54127Z"
        fill="#EA4335"
      />
    </g>
    <defs>
      <clipPath id="sb_g_clip">
  ...
  return (
    <div className="flex gap-3">
      <div className="relative flex-1">
        ...
        <div className="absolute inset-0 opacity-0 [&>div]:!w-full [&_iframe]:!w-full" aria-hidden>
          <GoogleLogin
            onSuccess={handleGoogleCredential}
            onError={() => toast.error("Google sign-in was cancelled or failed.")}
            useOneTap={false}
