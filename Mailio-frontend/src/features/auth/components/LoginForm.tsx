    ...
    <div className="space-y-5 sm:space-y-7">
      <div className="space-y-1.5 sm:space-y-2">
        <h2 className="inline-flex items-center gap-2 text-xl font-bold tracking-tight text-foreground sm:text-3xl">
          Welcome
          <svg
            className="h-5 w-5 sm:h-7 sm:w-7 text-[#F9C023]"
            viewBox="0 0 512 512"
            fill="none"
        ...
        <p className="text-xs leading-relaxed text-muted-foreground sm:text-sm">
          Sign in to continue managing your email verification, bulk uploads, and real-time
