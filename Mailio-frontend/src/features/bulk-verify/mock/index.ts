...
export const MOCK_RECENT_JOBS: BulkVerificationRecord[] = [
  { id: "1", fileName: "Spring Outreach List.csv",    totalEmails: 10_000, status: "processing", valid: 6_238, invalid: 512, catchall: 276, disposable: 100 },
  { id: "2", fileName: "CMO Leads May.csv",           totalEmails: 5_000,  status: "completed",  valid: 4_642, invalid: 198, catchall: 128, disposable:  32 },
  { id: "3", fileName: "Newsletter Signups.csv",      totalEmails: 2_480,  status: "completed",  valid: 2_157, invalid: 167, catchall:  96, disposable:  60 },
  { id: "4", fileName: "Old Leads Cleanup.csv",       totalEmails: 8_120,  status: "failed",     valid: null,  invalid: null, catchall: null, disposable: null },
  { id: "5", fileName: "Webinar Registrations.txt",   totalEmails: 3_210,  status: "completed",  valid: 2_812, invalid: 145, catchall:  88, disposable:  45 },
];

export const MOCK_CHART_DATA = [
  { name: "Valid",      value: 6_238, percentage: "68.3%", color: "#10b981" },
  { name: "Invalid",    value: 877,   percentage: "9.6%",  color: "#ef4444" },
  { name: "Catchall",      value: 1_711, percentage: "18.7%", color: "#f59e0b" },
