  ...
  Mail: {
    ...
    icon: ({ size = 12 }) => (
      <svg width={size} height={size} viewBox="0 0 12 12" fill="none" aria-hidden="true">
        <path
          d="M9.5 2.5H2.5C1.94772 2.5 1.5 2.94772 1.5 3.5V8.5C1.5 9.05228 1.94772 9.5 2.5 9.5H9.5C10.0523 9.5 10.5 9.05228 10.5 8.5V3.5C10.5 2.94772 10.0523 2.5 9.5 2.5Z"
          stroke="#0F5BFF"
          strokeWidth="1.1"
          strokeLinecap="round"
...
const TOOLTIP_BY_LABEL: Record<string, string> = {
  "total verified": "Total number of emails verified across single and bulk checks.",
  "valid rate":
    "Percentage of verified emails that are safe to send. These emails passed mailbox, domain checks.",
  "invalid rate": "Percentage of verified emails that failed verification.",
  "catchall rate": "Percentage of emails that are not fully invalid but may be catchall.",
};

function tooltipFor(label: string): string {
  return TOOLTIP_BY_LABEL[label.toLowerCase()] ?? `${label} for the selected period.`;
}
