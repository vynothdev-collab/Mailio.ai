...
export function ComingSoon({ description = "We're building something amazing." }: ComingSoonProps) {
  return (
    <div className="relative -mx-4 -mb-4 flex min-h-[100dvh] items-center justify-center overflow-hidden bg-[#EEF3FB] px-4 py-10 sm:px-6 lg:-mx-6 lg:-mb-6">
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at center, rgba(110, 231, 183, 0.45), rgba(167, 243, 208, 0.2) 50%, transparent 75%)",
        }}
        aria-hidden
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at center, rgba(96, 165, 250, 0.4), rgba(191, 219, 254, 0.2) 50%, transparent 75%)",
        }}
        aria-hidden
      />
      ...
      <div className="relative flex w-full max-w-xl flex-col items-center text-center">
        ...
        <p className="mt-4 max-w-md text-sm text-muted-foreground sm:text-base">{description}</p>
      </div>
