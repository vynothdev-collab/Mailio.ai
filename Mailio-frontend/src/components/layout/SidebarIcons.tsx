...
export function DashboardIcon({ active, size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" fill="none" aria-hidden="true">
      <path
        d="M6.375 2.25H3.375C2.75368 2.25 2.25 2.75368 2.25 3.375V7.875C2.25 8.49632 2.75368 9 3.375 9H6.375C6.99632 9 7.5 8.49632 7.5 7.875V3.375C7.5 2.75368 6.99632 2.25 6.375 2.25Z"
      ...
      />
      <path
        d="M14.625 2.25H11.625C11.0037 2.25 10.5 2.75368 10.5 3.375V4.875C10.5 5.49632 11.0037 6 11.625 6H14.625C15.2463 6 15.75 5.49632 15.75 4.875V3.375C15.75 2.75368 15.2463 2.25 14.625 2.25Z"
        stroke={stroke(active)}
        strokeWidth="1.35"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M14.625 9H11.625C11.0037 9 10.5 9.50368 10.5 10.125V14.625C10.5 15.2463 11.0037 15.75 11.625 15.75H14.625C15.2463 15.75 15.75 15.2463 15.75 14.625V10.125C15.75 9.50368 15.2463 9 14.625 9Z"
        stroke={stroke(active)}
        strokeWidth="1.35"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M6.375 12H3.375C2.75368 12 2.25 12.5037 2.25 13.125V14.625C2.25 15.2463 2.75368 15.75 3.375 15.75H6.375C6.99632 15.75 7.5 15.2463 7.5 14.625V13.125C7.5 12.5037 6.99632 12 6.375 12Z"
        stroke={stroke(active)}
        strokeWidth="1.35"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function BulkVerifyIcon({ active, size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" fill="none" aria-hidden="true">
      <path
        d="M14.25 5.25H3.75C2.92157 5.25 2.25 5.92157 2.25 6.75V13.5C2.25 14.3284 2.92157 15 3.75 15H14.25C15.0784 15 15.75 14.3284 15.75 13.5V6.75C15.75 5.92157 15.0784 5.25 14.25 5.25Z"
        stroke={stroke(active)}
        strokeWidth="1.35"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M2.25 6.75L9 11.25L15.75 6.75"
        stroke={stroke(active)}
        strokeWidth="1.35"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M4.5 5.25V3.75C4.5 3.35218 4.65804 2.97064 4.93934 2.68934C5.22064 2.40804 5.60218 2.25 6 2.25H12C12.3978 2.25 12.7794 2.40804 13.0607 2.68934C13.342 2.97064 13.5 3.35218 13.5 3.75V5.25"
        stroke={stroke(active)}
        strokeWidth="1.35"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function ResultsIcon({ active, size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" fill="none" aria-hidden="true">
      ...
      />
      <path
        d="M3 5.4001C3.49706 5.4001 3.9 4.99715 3.9 4.5001C3.9 4.00304 3.49706 3.6001 3 3.6001C2.50294 3.6001 2.1 4.00304 2.1 4.5001C2.1 4.99715 2.50294 5.4001 3 5.4001Z"
        fill={stroke(active)}
      />
      <path
        d="M3 9.9001C3.49706 9.9001 3.9 9.49715 3.9 9.0001C3.9 8.50304 3.49706 8.1001 3 8.1001C2.50294 8.1001 2.1 8.50304 2.1 9.0001C2.1 9.49715 2.50294 9.9001 3 9.9001Z"
        fill={stroke(active)}
      />
      <path
        d="M3 14.4001C3.49706 14.4001 3.9 13.9972 3.9 13.5001C3.9 13.003 3.49706 12.6001 3 12.6001C2.50294 12.6001 2.1 13.003 2.1 13.5001C2.1 13.9972 2.50294 14.4001 3 14.4001Z"
        fill={stroke(active)}
      />
    </svg>
  );
